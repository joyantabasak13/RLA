...
int main(int argc, char **argv)
{
	...
	// getData(filePath);
	recordVector.push_back("jons");
	recordVector.push_back("watkins");
	...
	for(int i=0; i<recordVector.size()-1; i++){
		for(int j=i+1; j<recordVector.size(); j++) {
			...
			cout<< "Quad algo1: " << jaroDist_1 << endl;
		}
	}
	double quadtotalCompTime	= (double)(clock() - currTS_q1) / CLOCKS_PER_SEC;
    cout<< "QuadAlg 2 Total Time " << quadtotalCompTime << endl;
	...
	for(int i=0; i<recordVector.size()-1; i++){
		for(int j=i+1; j<recordVector.size(); j++) {
			...
			cout<< "Quad algo2: " << jaroDist_2 << endl;
		}
	}
	...
	for(int i=0; i<recordVector.size()-1; i++){
		for(int j=i+1; j<recordVector.size(); j++) {
			...
			cout<< "Linear algo: " << jaroDistLinear << endl;
		}
	}

	double compTime	= (double)(clock() - currTS_l1) / CLOCKS_PER_SEC;
    cout<< " Total Time " << compTime << endl;
