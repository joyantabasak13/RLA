...
./eColiGenomeComp eColi_genes_100.txt
./eColiGenomeComp eColi_genes_200.txt
./eColiGenomeComp eColi_genes_300.txt
./eColiGenomeComp eColi_genes_400.txt
./eColiGenomeComp eColi_genes_500.txt
./eColiGenomeComp eColi_genes_600.txt
./eColiGenomeComp eColi_genes_700.txt
./eColiGenomeComp eColi_genes_800.txt
./eColiGenomeComp eColi_genes_900.txt
# ./eColiGenomeComp eColi_genes_500.txt
...
# ./randomStringComp randomString_size5_alpha5.txt
