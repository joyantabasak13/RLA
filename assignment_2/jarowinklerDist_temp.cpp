...
void createBlock_three_character(int indBlockField, int lmerUsed, int type, vector<vector<int>>& blockArr);
...
void findApproxCluster(vector<int>& rootArr)
{
	...
	for (int i = 0; i < blockFieldArr[0].size(); ++i)
	{
		...
		//createBlock_three_character(blockFieldArr[0][i], blockFieldArr[1][i] - NUMBER_LMER + 1, blockFieldArr[2][i], blockArr);
...
void createBlock(int indBlockField, int lmerUsed, int type, vector<vector<int>>& blockArr)
{
	...
	for (int i = 0; i < clusterExactIndArr.size(); ++i) {
		...
		for (int j = 0; j < blockFieldStr.length() - lmerUsed + 1; ++j)
		{
			...
			//blockID = ((blockID * 6607 + 99991) % 58211) % 503;
			//blockID = (((blockID * 601 + 999983)  % 499979) + 47) % 10007;
			...
			//blockID = ((((blockID * 601) + 999983) % 499979) + 47) % 503;
